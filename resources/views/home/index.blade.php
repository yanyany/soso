...
<head>
	...
	<link rel="stylesheet" href="{{ URL::asset('/') }}/web/css/style.css" media="screen" />
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,400,300,700" />
	<link rel="stylesheet" href="{{ URL::asset('/') }}/web/css/flexslider.css" media="screen" />

	<script src="{{ URL::asset('/') }}/web/js/jquery-1.7.2.min.js"></script>
	<script src="{{ URL::asset('/') }}/web/js/jQuery.BlackAndWhite.min.js"></script>
	<script src="{{ URL::asset('/') }}/web/js/jquery.easing-1.3.min.js"></script>
	<script src="{{ URL::asset('/') }}/web/Web/js/jquery.flexslider-min.js"></script>
	<script src="{{ URL::asset('/') }}/web/js/jquery.isotope.min.js"></script>
	<script src="{{ URL::asset('/') }}/web/js/jquery.jcarousel.min.js"></script>
	<script src="{{ URL::asset('/') }}/web/js/jquery.touchSwipe.min.js"></script>
	<script src="{{ URL::asset('/') }}/web/js/respond.min.js"></script>
	<script src="{{ URL::asset('/') }}/web/js/selectnav.min.js"></script>
	...
	<script type="text/javascript" src="_{{ URL::asset('/') }}/web/js/selectivizr-min.js"></script>
...
<div id="body-wrapper">
	...
	<div id="header" class="container clearfix">
		...
		<a href="./index.html" id="logo"><img src="{{ URL::asset('/') }}/web/images/logo.png" alt="" style="width:211px;height:81px"/></a>
	...
	<div id="content" class="container clearfix">
		...
		<div id="main-slider" class="flexslider">
			<ul class="slides">
				<li>
					<img src="{{ URL::asset('/') }}/web/images/dahai.jpg" alt="" />
		...
		<div id="project-wrapper" class="clearfix">
			...
			<ul class="project-carousel">
				...
				<li>
					<a href="./portfolio_details.html" class="project-item">
						<img src="{{ URL::asset('/') }}/web/images/content/project_4_06.jpg" alt="" />
						<div class="overlay">
				...
				<li>
					<a href="./portfolio_details.html" class="project-item">
						<img src="{{ URL::asset('/') }}/web/images/content/project_4_07.jpg" alt="" />
						<div class="overlay">
				...
				<li>
					<a href="./portfolio_details.html" class="project-item">
						<img src="{{ URL::asset('/') }}/web/images/content/project_4_09.jpg" alt="" />
						<div class="overlay">
				...
				<li>
					<a href="./portfolio_details.html" class="project-item">
						<img src="{{ URL::asset('/') }}/web/images/content/project_4_10.jpg" alt="" />
						<div class="overlay">
							<h5>The past</h5>
							<p>Print Design</p>
						</div>
		...
		<div class="logo-list">
			<ul>
				<li><a href="./index.html"><div class="bw-wrapper"><img src="{{ URL::asset('/') }}/web/images/content/logo_list_01.png" alt="" /></div></a></li>
				<li><a href="./index.html"><div class="bw-wrapper"><img src="{{ URL::asset('/') }}/web/images/content/logo_list_02.png" alt="" /></div></a></li>
				<li><a href="./index.html"><div class="bw-wrapper"><img src="{{ URL::asset('/') }}/web/images/content/logo_list_03.png" alt="" /></div></a></li>
				<li><a href="./index.html"><div class="bw-wrapper"><img src="{{ URL::asset('/') }}/web/images/content/logo_list_04.png" alt="" /></div></a></li>
				<li><a href="./index.html"><div class="bw-wrapper"><img src="{{ URL::asset('/') }}/web/images/content/logo_list_05.png" alt="" /></div></a></li>
			</ul>
		</div>
		<!-- /Logo List -->
	...
	<div id="footer">
		<div class="container clearfix">
			...
			<div class="one-fourth">
				<a href="./index.html" class="logo"><img src="{{ URL::asset('/') }}/web/images/logo_footer.png" alt="" /></a>
			...
			<div class="one-fourth last">
				...
				<ul class="photo-stream">
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/images/content/photo_stream_01.jpg" alt="" /></a></li>
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/images/content/photo_stream_02.jpg" alt="" /></a></li>
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/images/content/photo_stream_03.jpg" alt="" /></a></li>
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/content/photo_stream_04.jpg" alt="" /></a></li>
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/images/content/photo_stream_05.jpg" alt="" /></a></li>
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/images/content/photo_stream_06.jpg" alt="" /></a></li>
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/images/content/photo_stream_07.jpg" alt="" /></a></li>
					<li><a href="./index.html"><img src="{{ URL::asset('/') }}/web/images/content/photo_stream_08.jpg" alt="" /></a></li>
				</ul>
			</div>
			<!-- /Photo Stream -->
